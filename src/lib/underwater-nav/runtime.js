...
/**
 * Binds open/close events for the checkbox nav toggle.
 * @param {HTMLInputElement} navToggle
 */
export function bindNavToggle(navToggle) {
  document.addEventListener('keyup', (e) => {
    if (
      e.target.className.indexOf('nav-toggle') &&
  ...
  navToggle.addEventListener('change', (e) => {
    const eventName = e.target.checked ? 'navOpen' : 'navClose';
...
/**
 * Initialises underwater navigation on the given nav element.
